About keystoneauth1-feedstock
=============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/keystoneauth1-feedstock/blob/main/LICENSE.txt)
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/keystoneauth1-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/keystoneauth1-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `keystoneauth1` can be installed with `conda`:
...
```
mamba install keystoneauth1
```

It is possible to list all of the versions of `keystoneauth1` available on your platform with `conda`:
...
```
mamba search keystoneauth1 --channel conda-forge
```
...
mamba repoquery search keystoneauth1 --channel conda-forge

# List packages depending on `keystoneauth1`:
mamba repoquery whoneeds keystoneauth1 --channel conda-forge

# List dependencies of `keystoneauth1`:
mamba repoquery depends keystoneauth1 --channel conda-forge
```
